              ...
              <SwiperSlide>
                <div className="flex flex-col-reverse md:flex-row gap-6 w-10/12 mx-auto py-10">
                  <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-2xl lg:text-left">
                    <p className="font-bold uppercase text-primary font-accent">
                      Limited-Time Tech Deal
                    </p>
                    ...
                    <p className="mt-6 mb-8 text-lg sm:mb-12 text-gray-300">
                      Stock up on laptops, smartphones & accessories. Min order:
                      50 units.
                    </p>
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                      <a
                        href="#electronics"
                        className="btn btn-accent font-accent rounded-full"
                      >
                        Claim Deal Now
                      </a>
                    </div>
              ...
              <SwiperSlide>
                <div className="flex flex-col-reverse md:flex-row gap-6 w-10/12 mx-auto py-10">
                  <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-2xl lg:text-left">
                    ...
                    <p className="mt-6 mb-8 text-lg sm:mb-12 text-gray-300">
                      Top-tier tools & equipment, direct from makers. Min order:
                      50 units.
                    </p>
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                      <a
